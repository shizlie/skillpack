...
10. [ ] Deploy verification: add post-deploy smoke coverage for the hosted pair (`/healthz`, `/app-config`, authenticated dashboard proxy call, provider/customer/workspace create, policy issue, meter upload, usage summary, billing invoice draft).
