⚠️ TSA outage past 7d for air-gapped customer with no sneakernet operator — silent failure mode. Customer's self-hosted server stops issuing leases → in-field skills die at
